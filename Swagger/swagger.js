          ...
          "application/json": {
            schema: {
              ...
              properties: {
                ...
                message: { type: "string", example: "You don't have permission to perform this action" },
          ...
          "application/json": {
            schema: {
              ...
              properties: {
                ...
                message: { type: "string", example: "Resource already exists or conflicts with existing data" },
